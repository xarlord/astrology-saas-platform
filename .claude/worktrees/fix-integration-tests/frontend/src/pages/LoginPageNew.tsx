      ...
      <div className="flex min-h-screen w-full flex-col lg:flex-row">
          ...
          <div className="relative z-20 flex h-full flex-col justify-between p-12 xl:p-16">
            ...
            <Link to="/" className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/10 backdrop-blur-sm border border-white/10">
                <span className="material-symbols-outlined text-accent-gold" style={{ fontSize: '24px' }}>
                  auto_awesome
                </span>
              </div>
            ...
            >
              <svg fill="none" height="400" viewBox="0 0 400 400" width="400" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" id="wheelGradient" x1="200" x2="200" y1="0" y2="400">
                    <stop stopColor="#A78BFA" stopOpacity="0.8"></stop>
                    <stop offset="1" stopColor="#2563EB" stopOpacity="0.1"></stop>
                  </linearGradient>
                </defs>
                <circle cx="200" cy="200" r="198" stroke="url(#wheelGradient)" strokeDasharray="8 8" strokeWidth="1"></circle>
                <circle cx="200" cy="200" r="150" stroke="url(#wheelGradient)" strokeWidth="1"></circle>
                <circle cx="200" cy="200" r="100" stroke="url(#wheelGradient)" strokeDasharray="4 4" strokeWidth="0.5"></circle>
              </svg>
            </div>
            ...
            <div className="max-w-md">
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-medium text-primary-200 backdrop-blur-md">
                <span className="material-symbols-outlined text-[14px]">spark</span>
        ...
        <div className="flex w-full flex-1 flex-col justify-center bg-gradient-to-br from-[#0B0D17] to-[#141627] px-4 py-12 sm:px-6 lg:px-20 xl:px-24">
          <div className="mx-auto w-full max-w-[420px]">
            ...
            >
              <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); void handleSubmit(e); }}>
                {/* Email Field */}
                <div>
