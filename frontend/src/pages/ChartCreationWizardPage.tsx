      ...
      <main className="relative z-10 flex flex-1 flex-col pt-20 pb-6 px-4 sm:px-8 h-screen max-h-screen overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-6 max-w-6xl mx-auto w-full flex-1 min-h-0">
          ...
          <div className="w-full lg:w-80 bg-card-dark/80 backdrop-blur-md rounded-2xl p-6 flex flex-col gap-6 hidden md:flex sticky top-0 self-start">
            ...
            {/* Mini Chart Wheel */}
            <div className="relative aspect-square w-full rounded-full border border-white/10 flex items-center justify-center bg-gradient-to-br from-cosmic-page to-cosmic-card-solid/30 overflow-hidden group">
              {/* SVG Wheel */}
              <svg
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-cosmic-page to-cosmic-card-solid border border-white/10 flex items-center justify-center mb-1 shadow-lg z-10">
