  ...
  return (
    <div className="min-h-screen bg-background-dark text-slate-100 font-display antialiased overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-background-dark">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[800px] opacity-60 pointer-events-none">
          <div
            ...
            style={{
              background: 'radial-gradient(circle at 50% 50%, rgba(123, 59, 227, 0.15) 0%, rgba(11, 13, 23, 0) 50%)',
            }}
          />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left space-y-8">
              ...
              <h1 className="text-5xl lg:text-7xl font-black tracking-tight leading-[1.1]">
                ...
                <br />
                <span className="text-primary" style={{ textShadow: '0 0 20px rgba(123, 59, 227, 0.5)' }}>
                  Cosmic Blueprint
                </span>
              </h1>

              <p className="text-lg lg:text-xl text-slate-400 max-w-2xl mx-auto lg:mx-0 font-light leading-relaxed">
                Unlock the secrets of your natal chart with AI-powered insights and hyper-personalized
                transit forecasts. Align your life with the stars.
              </p>
            ...
            <div className="relative lg:h-[600px] flex items-center justify-center">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-slate-400 uppercase tracking-wider">Current Transit</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-400 text-lg">
              Our comprehensive suite of astrological tools helps you navigate life's cosmic currents
              with precision.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                >
                  <span className="material-symbols-outlined text-3xl text-primary">timelapse</span>
                </div>
                <h4 className="text-xl font-bold text-white mb-3">Natal Charts</h4>
                <p className="text-slate-400 leading-relaxed">
                  Deep dive analysis of your birth chart with precise planetary positions calculated to
                  the second.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-400 leading-relaxed">
                  Psychological profiling based on elemental balances and modalities. Understand your
                  true self.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-400 leading-relaxed">
                  Predictive planning tools to navigate retrogrades and transits. Know when to act and
                  when to pause.
                </p>
              </div>
            </div>
              ...
              <div className="flex items-center gap-2">
                <div className="flex text-accent-gold">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <span key={i} className="material-symbols-outlined fill-current text-xl">
                      star
                    </span>
                  ))}
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              <div>
                ...
                <p className="text-slate-300 text-lg leading-relaxed mb-6">
                  "AstroVerse completely changed how I plan my month. The transit accuracy is scary
                  good! I feel so much more aligned."
                </p>
              </div>
            ...
            >
              <div>
                ...
                <p className="text-slate-300 text-lg leading-relaxed mb-6">
                  "The natal chart breakdown is so detailed, it felt like a professional reading. The
                  UI is absolutely stunning."
                </p>
              </div>
              <div className="flex items-center gap-3 pt-4 border-t border-white/5">
                <img
      ...
      <section className="py-24 bg-[#0F111E]" id="pricing">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Invest in Your Journey</h2>
            <p className="text-slate-400 text-lg">Choose the plan that best fits your path to self-discovery.</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2 lg:col-span-2">
              <div className="flex items-center gap-2 mb-6">
                <span className="material-symbols-outlined text-3xl text-primary">pentagon</span>
