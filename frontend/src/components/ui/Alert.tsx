    ...
    >
      <div className="flex">
        ...
        <div className="ml-3 flex-1">
          {title && <h3 className={clsx('mb-1', titleSizeClasses[size])}>{title}</h3>}
          <div>{children}</div>
          ...
          <div className="ml-auto pl-3">
            <button
              ...
              className={clsx(
                ...
                variant === 'error' &&
                  'hover:bg-red-100 dark:hover:bg-red-900/30 focus:ring-red-600',
                variant === 'warning' &&
                  'hover:bg-yellow-100 dark:hover:bg-yellow-900/30 focus:ring-yellow-600',
                variant === 'success' &&
                  'hover:bg-green-100 dark:hover:bg-green-900/30 focus:ring-green-600',
                variant === 'info' &&
                  'hover:bg-blue-100 dark:hover:bg-blue-900/30 focus:ring-blue-600',
              )}
