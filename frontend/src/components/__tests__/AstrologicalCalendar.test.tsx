...
describe('AstrologicalCalendar Component', () => {
  ...
  describe('Month Navigation', () => {
    it('should have navigation buttons available', () => {
      (useCalendarEvents as any).mockReturnValue({
        data: { data: [{ id: '1', event_type: 'new_moon', event_date: '2026-01-10', interpretation: 'Test', event_data: {} }], meta: { total: 1 } },
        isLoading: false,
        error: null,
        refetch: vi.fn(),
      });
  ...
  describe('Edge Cases', () => {
    it('should handle leap years', () => {
      (useCalendarEvents as any).mockReturnValue({
        data: { data: [{ id: '1', event_type: 'new_moon', event_date: '2024-02-10', interpretation: 'Test', event_data: {} }], meta: { total: 1 } },
        isLoading: false,
        error: null,
        refetch: vi.fn(),
      });
    ...
    it('should handle different months', () => {
      (useCalendarEvents as any).mockReturnValue({
        data: { data: [{ id: '1', event_type: 'new_moon', event_date: '2026-08-10', interpretation: 'Test', event_data: {} }], meta: { total: 1 } },
        isLoading: false,
        error: null,
        refetch: vi.fn(),
      });
