        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.15)] p-5 relative animate-slide-in sm:p-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-2 sm:flex-col">
              <button
                className="flex-1 py-2.5 px-4 rounded-lg text-sm font-medium cursor-pointer transition-all duration-200 border-none bg-gradient-to-br from-indigo-500 to-purple-500 text-white hover:not-disabled:-translate-y-px hover:not-disabled:shadow-[0_4px_12px_rgba(99,102,241,0.4)] disabled:opacity-60 disabled:cursor-not-allowed sm:w-full"
