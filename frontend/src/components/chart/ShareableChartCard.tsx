      ...
      <div className="relative flex flex-col items-center gap-4 w-full max-w-[20rem]">
        ...
        <div className="flex space-x-3">
          <div className="flex flex-col items-center">
            <div className="w-5 h-5 flex items-center justify-center text-lg">{getZodiacSymbol(sunSign)}</div>
            <div className="text-xs font-medium">{sunSign}</div>
          </div>
          <div className="w-px h-5 bg-primary/20" />
          <div className="flex flex-col items-center">
            <div className="w-5 h-5 flex items-center justify-center text-lg">{getZodiacSymbol(moonSign)}</div>
            <div className="text-xs font-medium">{moonSign}</div>
          </div>
          <div className="w-px h-5 bg-primary/20" />
          <div className="flex flex-col items-center">
            <div className="w-5 h-5 flex items-center justify-center text-lg">{getZodiacSymbol(risingSign)}</div>
        ...
        <div className="text-center space-y-1">
          ...
          <p className="text-[12px] italic text-secondary-gray">
            "Today's cosmic energy supports"
          </p>
