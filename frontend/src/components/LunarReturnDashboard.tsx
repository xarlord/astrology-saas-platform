    ...
    return (
      <div className="max-w-[1200px] mx-auto p-5">
        <div className="rounded-xl bg-red-50 p-10 text-center text-red-600">
          ...
          <button onClick={() => { void loadData(); }} type="button" className="rounded-md bg-purple-600 px-5 py-2.5 font-semibold text-white hover:bg-purple-700 transition-colors">
            Try Again
          </button>
        </div>
      </div>
