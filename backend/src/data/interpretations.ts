...
export const planetsInSigns: Record<string, Record<string, PlanetInSignInterpretation>> = {
  ...
  // ========================================================================
  // CHIRON — The Wounded Healer (grounded in Zane Stein, Barbara Hand Clow,
  // Melanie Reinhart: "Chiron and the Healing Journey", "Saturn, Chiron, and the Centaurs")
  // ========================================================================
  chiron: {
    aries: {
      planet: 'chiron',
      sign: 'aries',
      keywords: ['identity wound', 'courageous healing', 'pioneering medicine', 'self-worth wound', 'warrior healer'],
      general: 'Chiron in Aries points to a deep wound around identity and self-assertion. You may have experienced early situations where your right to exist independently was invalidated. The healing path involves discovering that true courage comes not from dominating others but from standing authentically in your own truth. Through this wound, you develop the ability to help others reclaim their sense of self.',
      strengths: ['Ability to help others find courage', 'Pioneering new healing approaches', 'Teaching self-advocacy by example', 'Transforming personal wounds into wisdom', 'Leading others through identity crises'],
      challenges: ['Difficulty asserting personal needs', 'Wounds around being seen as "too much"', 'Impatience with own healing process', 'Tendency to overcompensate with aggression', 'Struggling to ask for help'],
      advice: ['Honor your need for independence without isolating', 'Practice gentle self-assertion daily', 'Your wound around identity is your greatest teaching gift', 'Allow anger to teach you rather than consume you'],
    },
    taurus: {
      planet: 'chiron',
      sign: 'taurus',
      keywords: ['worth wound', 'body wisdom', 'sensual healing', 'resource trauma', 'earth medicine'],
      general: 'Chiron in Taurus reveals a wound around self-worth and material security. You may have grown up feeling that your value was measured by what you produced or owned rather than who you are. The healing journey involves reconnecting with your body as a source of wisdom and learning that your worth is inherent, not earned.',
      strengths: ['Deep body-awareness and somatic wisdom', 'Ability to help others heal self-worth issues', 'Creating beauty from personal pain', 'Teaching sustainable self-care practices', 'Grounding spiritual insights into tangible form'],
      challenges: ['Feeling never having enough', 'Difficulty enjoying pleasure without guilt', 'Resistance to change in routine', 'Equating self-worth with productivity', 'Material insecurity driving anxiety'],
      advice: ['Practice receiving without guilt', 'Your body holds healing wisdom — listen to it', 'Build security from inner values, not outer validation', 'Teach others that worth is inherent, not accumulated'],
    },
    gemini: {
      planet: 'chiron',
      sign: 'gemini',
      keywords: ['communication wound', 'mind healing', 'voice recovery', 'learning trauma', 'story medicine'],
      general: 'Chiron in Gemini indicates a wound around communication, learning, or being truly heard. Early experiences may have taught you that your voice did not matter or that your way of processing information was flawed. The healing path involves reclaiming your authentic voice and using your experience to help others find theirs.',
      strengths: ['Transforming communication struggles into teaching gifts', 'Understanding those who feel unheard', 'Weaving personal stories into universal wisdom', 'Creating safe spaces for difficult conversations', 'Translating complex pain into accessible language'],
      challenges: ['Second-guessing your own words', 'Fear of being misunderstood', 'Intellectual self-doubt', 'Scattered thinking under stress', 'Over-explaining or under-communicating'],
      advice: ['Trust that your unique perspective has value', 'Write or speak your truth even when your voice shakes', 'Your communication wound makes you an exceptional listener', 'Teach others that being understood starts with self-understanding'],
    },
    cancer: {
      planet: 'chiron',
      sign: 'cancer',
      keywords: ['family wound', 'emotional healing', 'nurturing trauma', 'belonging wound', 'home medicine'],
      general: 'Chiron in Cancer points to a wound around belonging, family, and emotional safety. You may have experienced early emotional neglect, family dysfunction, or a sense of not truly belonging anywhere. The healing journey involves learning to mother yourself and creating emotional safety that you can then offer to others.',
      strengths: ['Exceptional capacity for emotional healing', 'Creating chosen family and safe spaces', 'Teaching emotional intelligence through lived experience', 'Transforming family pain into nurturing wisdom', 'Helping others process generational trauma'],
      challenges: ['Fear of emotional vulnerability', 'Clinging to relationships for security', 'Absorbing others\' emotional pain', 'Difficulty feeling "at home" anywhere', 'Tendency to over-nurture and under-receive'],
      advice: ['You cannot heal the family wound by fixing others — start with yourself', 'Create rituals of self-nurturing that you needed as a child', 'Your emotional sensitivity is your greatest healing gift', 'Allow yourself to be parented by life itself'],
    },
    leo: {
      planet: 'chiron',
      sign: 'leo',
      keywords: ['creative wound', 'expression trauma', 'recognition pain', 'heart healing', 'joy recovery'],
      general: 'Chiron in Leo reveals a wound around creative expression, recognition, and being seen for who you truly are. Early experiences may have taught you that it was unsafe to shine or that your creative gifts were unworthy. The healing path involves reclaiming your right to express yourself fully and helping others rediscover their creative fire.',
      strengths: ['Helping others overcome creative blocks', 'Teaching authentic self-expression', 'Transforming personal shame into artistic power', 'Mentoring others to claim their spotlight', 'Finding joy after heartbreak'],
      challenges: ['Fear of being seen as attention-seeking', 'Creative paralysis from perfectionism', 'Feeling unappreciated despite efforts', 'Difficulty receiving compliments', 'Withholding your gifts from the world'],
      advice: ['Your creative wound is the source of your most powerful art', 'Practice being seen without apology', 'Teach others that creativity is a birthright, not a privilege', 'Allow yourself to play without needing a productive outcome'],
    },
    virgo: {
      planet: 'chiron',
      sign: 'virgo',
      keywords: ['perfection wound', 'service healing', 'body wisdom', 'criticism trauma', 'wholeness medicine'],
      general: 'Chiron in Virgo indicates a wound around perfection, usefulness, and physical well-being. You may have internalized the belief that you must be perfect to be worthy of love or help. The healing journey involves accepting your imperfections and recognizing that your wound makes you an extraordinarily perceptive healer.',
      strengths: ['Exceptional diagnostic and healing abilities', 'Transforming self-criticism into compassionate service', 'Teaching the sacred art of daily self-care', 'Finding meaning in health challenges', 'Helping others accept their imperfections'],
      challenges: ['Harsh inner critic that never rests', 'Using service to avoid personal needs', 'Health anxiety or body-criticism', 'Feeling never good enough despite achievements', 'Difficulty accepting imperfect help from others'],
      advice: ['Your imperfections are not flaws — they are your curriculum', 'Practice receiving help as an act of service to the helper', 'Your body wisdom is profound — trust it over any expert', 'Healing happens in the daily rituals, not the grand gestures'],
    },
    libra: {
      planet: 'chiron',
      sign: 'libra',
      keywords: ['relationship wound', 'justice healing', 'harmony trauma', 'fairness pain', 'partnership medicine'],
      general: 'Chiron in Libra reveals a wound around relationships, fairness, and the balance between self and other. Early experiences may have taught you that love requires self-abandonment or that conflict is intolerable. The healing path involves learning healthy boundaries within relationships and using your wound to help others find equitable partnership.',
      strengths: ['Teaching healthy relationship dynamics', 'Mediating conflicts from deep understanding', 'Helping others reclaim their voice in partnerships', 'Creating beauty that bridges differences', 'Modeling vulnerability in connection'],
      challenges: ['Losing yourself in relationships', 'Avoiding necessary conflict', 'Tolerating unfairness to keep peace', 'Difficulty being alone', 'Projecting idealized expectations onto partners'],
      advice: ['True partnership requires two whole people, not two halves', 'Practice saying "no" as an act of love', 'Your wound around fairness makes you a natural advocate', 'Balance is not static — it is a continuous adjustment'],
    },
    scorpio: {
      planet: 'chiron',
      sign: 'scorpio',
      keywords: ['power wound', 'transformation healing', 'trust trauma', 'intensity medicine', 'depth recovery'],
      general: 'Chiron in Scorpio indicates a wound around trust, power, and intimacy. You may have experienced early betrayal, abuse of power, or situations where your deepest feelings were used against you. The healing path involves transforming through the wound itself — diving into your own depths to emerge as a powerful healer of emotional trauma.',
      strengths: ['Extraordinary capacity for transformational healing', 'Helping others navigate grief and loss', 'Teaching healthy use of personal power', 'Transforming trauma into wisdom and purpose', 'Holding space for the most difficult emotions'],
      challenges: ['Fear of betrayal and abandonment', 'Tendency toward emotional extremes', 'Difficulty trusting intimate connections', 'Power struggles in relationships', 'Holding onto pain as identity'],
      advice: ['Your deepest wound is the source of your greatest power', 'Trust is built through small consistent acts of vulnerability', 'You do not need to control everything to be safe', 'Allow transformation to happen — resistance prolongs suffering'],
    },
    sagittarius: {
      planet: 'chiron',
      sign: 'sagittarius',
      keywords: ['meaning wound', 'belief healing', 'truth trauma', 'wisdom recovery', 'faith medicine'],
      general: 'Chiron in Sagittarius reveals a wound around meaning, belief systems, and the search for truth. You may have experienced a crisis of faith, been let down by teachers or institutions, or struggled to find a belief system that honors your direct experience. The healing path involves becoming your own spiritual authority.',
      strengths: ['Teaching others through personal existential inquiry', 'Bridging diverse belief systems', 'Finding humor in the sacred search', 'Helping others through spiritual crises', 'Transforming dogma into living wisdom'],
      challenges: ['Spiritual bypassing emotional pain', 'Fanaticism or rejection of all beliefs', 'Feeling perpetually lost spiritually', 'Dismissing lived experience for abstract truth', 'Restlessness that avoids inner work'],
      advice: ['Your doubt is not weakness — it is the beginning of genuine faith', 'Travel inward before traveling outward', 'Teach what you most need to learn', 'Meaning is created, not found — trust your direct experience'],
    },
    capricorn: {
      planet: 'chiron',
      sign: 'capricorn',
      keywords: ['authority wound', 'achievement healing', 'responsibility trauma', 'structure recovery', 'wisdom medicine'],
      general: 'Chiron in Capricorn indicates a wound around authority, achievement, and responsibility. You may have grown up feeling that love was conditional upon accomplishment, or that authority figures were unreliable. The healing path involves redefining success on your own terms and becoming a wise, compassionate authority for yourself and others.',
      strengths: ['Teaching healthy ambition without burnout', 'Building structures that support genuine well-being', 'Mentoring others through career and life transitions', 'Transforming authority wounds into wise leadership', 'Showing others that vulnerability is strength'],
      challenges: ['Over-identifying with achievements', 'Fear of failure that paralyzes action', 'Difficulty trusting authority figures', 'Taking on too much responsibility', 'Feeling unworthy without external validation'],
      advice: ['Your worth is not measured by your productivity', 'True authority comes from self-knowledge, not control', 'Allow yourself to fail — it is how wisdom is built', 'Mentor others not from expertise but from shared humanity'],
    },
    aquarius: {
      planet: 'chiron',
      sign: 'aquarius',
      keywords: ['belonging wound', 'individuality healing', 'community trauma', 'rebel medicine', 'group recovery'],
      general: 'Chiron in Aquarius reveals a wound around belonging, individuality, and community. You may have felt like an outsider your entire life, or experienced rejection for being different. The healing path involves embracing your unique frequency and using it to help others who feel marginalized find their place in the world.',
      strengths: ['Creating inclusive communities from personal exclusion', 'Helping others embrace their uniqueness', 'Innovative approaches to collective healing', 'Teaching the value of diversity in all forms', 'Transforming alienation into radical acceptance'],
      challenges: ['Feeling fundamentally different from everyone', 'Rebellion that becomes self-isolation', 'Difficulty trusting group dynamics', 'Hiding your uniqueness to fit in', 'Detachment as a defense against rejection'],
      advice: ['Your difference is your gift to the collective', 'Community is built one authentic connection at a time', 'Allow yourself to belong without losing your edge', 'Teach others that inclusion starts with self-acceptance'],
    },
    pisces: {
      planet: 'chiron',
      sign: 'pisces',
      keywords: ['spiritual wound', 'surrender healing', 'boundary recovery', 'compassion medicine', 'unity trauma'],
      general: 'Chiron in Pisces indicates a wound around spiritual connection, boundaries, and the dissolution of self. You may have experienced spiritual abuse, struggled with addiction, or felt overwhelmed by the suffering of the world. The healing path involves learning healthy compassion without self-sacrifice and finding the divine within your own wound.',
      strengths: ['Profound capacity for spiritual healing and guidance', 'Teaching healthy compassion and boundaries', 'Transforming personal suffering into universal empathy', 'Helping others through dark nights of the soul', 'Channeling creative and spiritual inspiration'],
      challenges: ['Boundary dissolution and energetic overwhelm', 'Escapism through fantasy or substances', 'Victim consciousness or martyrdom', 'Difficulty distinguishing self from others\' pain', 'Spiritual bypassing emotional work'],
      advice: ['Your sensitivity is not a weakness to fix but a gift to protect', 'Ground your spiritual insights in daily practice', 'Compassion without boundaries is self-destruction', 'The divine lives in your wound, not apart from it'],
    },
  },
  // ========================================================================
  // NORTH NODE — Karmic life path (grounded in traditional Vedic/Lunar Node
  // astrology, Martin Schulman "Karmic Astrology", Jan Spiller "Astrology for the Soul")
  // ========================================================================
  northnode: {
    aries: {
      planet: 'northnode',
      sign: 'aries',
      keywords: ['karmic independence', 'soul courage', 'self-discovery path', 'pioneering destiny', 'individuality dharma'],
      general: 'North Node in Aries indicates your soul\'s evolutionary path leads toward developing independence and self-trust. Past-life tendencies toward excessive compromise or dependency (South Node in Libra) must be released. Your destiny requires learning to act on your own impulses, make decisions independently, and develop the courage to be yourself.',
      strengths: ['Natural ability to initiate new beginnings', 'Courage to walk unfamiliar paths', 'Inspiring others through authentic self-expression', 'Learning to trust inner knowing over consensus'],
      challenges: ['Defaulting to others\' preferences to avoid conflict', 'Fear of acting alone without validation', 'Difficulty making decisions without input', 'Tendency to lose yourself in partnerships'],
      advice: ['Practice making small decisions independently daily', 'Your first instinct is usually correct — trust it', 'Conflict is not the enemy — suppression of self is', 'Your growth requires healthy selfishness'],
    },
    taurus: {
      planet: 'northnode',
      sign: 'taurus',
      keywords: ['karmic stability', 'soul patience', 'grounding path', 'resource dharma', 'sensual destiny'],
      general: 'North Node in Taurus indicates your soul\'s path leads toward building lasting stability and appreciating the physical world. Past-life tendencies toward emotional crisis and self-transformation (South Node in Scorpio) must be released. Your destiny requires learning patience, building tangible resources, and finding peace in simplicity.',
      strengths: ['Ability to build lasting foundations', 'Deep appreciation for beauty and comfort', 'Teaching others the value of patience', 'Creating stability from chaos'],
      challenges: ['Creating unnecessary drama or crisis', 'Difficulty enjoying simple pleasures', 'Compulsive need for intensity and transformation', 'Sabotaging stable situations'],
      advice: ['Practice being present in your body and senses', 'Build something tangible and enduring', 'Peace is not boring — it is the ground of true power', 'Your path is through patient construction, not dramatic transformation'],
    },
    gemini: {
      planet: 'northnode',
      sign: 'gemini',
      keywords: ['karmic communication', 'soul learning', 'voice path', 'teaching dharma', 'curiosity destiny'],
      general: 'North Node in Gemini indicates your soul\'s path leads toward developing communication skills and intellectual curiosity. Past-life tendencies toward philosophical certainty and dogmatic teaching (South Node in Sagittarius) must be released. Your destiny involves learning to listen, stay curious, and communicate your experience without preaching.',
      strengths: ['Ability to translate complex wisdom into everyday language', 'Natural curiosity that opens doors', 'Teaching through storytelling and dialogue', 'Connecting diverse perspectives'],
      challenges: ['Preaching rather than conversing', 'Claiming to have all the answers', 'Restlessness that prevents depth', 'Difficulty staying present in mundane conversations'],
      advice: ['Practice truly listening without formulating your response', 'Your wisdom deepens through genuine dialogue, not monologue', 'Stay curious about the person in front of you', 'Write and share your story — your voice matters'],
    },
    cancer: {
      planet: 'northnode',
      sign: 'cancer',
      keywords: ['karmic nurturing', 'soul vulnerability', 'home path', 'emotional dharma', 'family destiny'],
      general: 'North Node in Cancer indicates your soul\'s path leads toward emotional vulnerability and nurturing. Past-life tendencies toward emotional control and authority (South Node in Capricorn) must be released. Your destiny involves learning to express feelings, create emotional safety, and allow yourself to be cared for.',
      strengths: ['Ability to create safe emotional spaces for others', 'Wisdom about the architecture of family and home', 'Teaching that vulnerability is strength', 'Transforming ambition into genuine caring'],
      challenges: ['Defaulting to emotional self-sufficiency', 'Difficulty asking for emotional support', 'Over-focusing on achievement to avoid feelings', 'Fear of appearing needy or weak'],
      advice: ['Practice expressing one genuine feeling each day', 'Let people care for you — receiving is a skill', 'Your home is your spiritual practice ground', 'True strength includes the capacity to be soft'],
    },
    leo: {
      planet: 'northnode',
      sign: 'leo',
      keywords: ['karmic creativity', 'soul joy', 'expression path', 'play dharma', 'heart destiny'],
      general: 'North Node in Leo indicates your soul\'s path leads toward creative self-expression and reclaiming joy. Past-life tendencies toward group conformity and intellectual detachment (South Node in Aquarius) must be released. Your destiny involves learning to follow your heart, create from authentic impulse, and allow yourself to be seen.',
      strengths: ['Ability to inspire others through creative courage', 'Finding joy in the creative process itself', 'Teaching that play is sacred', 'Leading from the heart, not the mind'],
      challenges: ['Defaulting to group consensus over inner knowing', 'Fear of appearing vain or self-important', 'Intellectualizing feelings rather than expressing them', 'Hiding your light to make others comfortable'],
      advice: ['Create something daily without needing it to be useful', 'Your joy is not selfish — it is your gift to the world', 'Follow your heart even when the logic is unclear', 'Let yourself be seen — your authenticity frees others'],
    },
    virgo: {
      planet: 'northnode',
      sign: 'virgo',
      keywords: ['karmic service', 'soul humility', 'craft path', 'health dharma', 'detail destiny'],
      general: 'North Node in Virgo indicates your soul\'s path leads toward practical service and developing discernment. Past-life tendencies toward spiritual bypass and victim consciousness (South Node in Pisces) must be released. Your destiny involves learning to be of practical service, developing your craft, and honoring the sacred in daily rituals.',
      strengths: ['Ability to find the sacred in ordinary tasks', 'Teaching practical self-improvement', 'Discernment that cuts through confusion', 'Grounding spiritual wisdom into actionable steps'],
      challenges: ['Escaping into fantasy instead of addressing problems', 'Difficulty maintaining daily routines', 'Feeling overwhelmed by physical-world demands', 'Sacrificing yourself without truly serving'],
      advice: ['Start with one small daily ritual and build from there', 'Your body is your temple — treat it accordingly', 'Service is not sacrifice — it is alignment', 'Discernment is not judgment — it is clarity with compassion'],
    },
    libra: {
      planet: 'northnode',
      sign: 'libra',
      keywords: ['karmic partnership', 'soul balance', 'relationship path', 'diplomacy dharma', 'harmony destiny'],
      general: 'North Node in Libra indicates your soul\'s path leads toward genuine partnership and learning the art of compromise. Past-life tendencies toward excessive independence and self-reliance (South Node in Aries) must be released. Your destiny involves learning to truly collaborate, value others\' perspectives, and find strength in interdependence.',
      strengths: ['Modeling healthy interdependence', 'Teaching the art of conscious compromise', 'Creating beauty through collaboration', 'Balancing assertiveness with receptivity'],
      challenges: ['Defaulting to going it alone', 'Impatience with others\' pace or process', 'Difficulty truly listening without forming rebuttals', 'Valuing independence over connection'],
      advice: ['Practice asking for help before you need it', 'True strength includes the capacity to lean on others', 'Your growth is through partnership, not solo achievement', 'Listen to understand, not to respond'],
    },
    scorpio: {
      planet: 'northnode',
      sign: 'scorpio',
      keywords: ['karmic transformation', 'soul depth', 'intimacy path', 'power dharma', 'healing destiny'],
      general: 'North Node in Scorpio indicates your soul\'s path leads toward emotional depth, transformation, and shared resources. Past-life tendencies toward clinging to comfort and material simplicity (South Node in Taurus) must be released. Your destiny involves learning to face your shadows, share resources deeply, and embrace transformation.',
      strengths: ['Ability to guide others through dark emotional terrain', 'Teaching the power of vulnerability and surrender', 'Transforming shared pain into collective wisdom', 'Deep emotional intelligence and perception'],
      challenges: ['Resistance to emotional intensity', 'Clinging to comfort and predictability', 'Difficulty sharing resources or power', 'Fear of loss driving hoarding behavior'],
      advice: ['Let go of what you\'re holding too tightly — surrender creates space', 'True intimacy requires showing your dark side', 'Transformation is not destruction — it is evolution', 'Your depth is your greatest asset'],
    },
    sagittarius: {
      planet: 'northnode',
      sign: 'sagittarius',
      keywords: ['karmic meaning', 'soul exploration', 'wisdom path', 'truth dharma', 'adventure destiny'],
      general: 'North Node in Sagittarius indicates your soul\'s path leads toward finding personal meaning and exploring diverse perspectives. Past-life tendencies toward scattered thinking and superficial communication (South Node in Gemini) must be released. Your destiny involves developing a personal philosophy, seeking truth through direct experience, and teaching from lived wisdom.',
      strengths: ['Ability to synthesize diverse experiences into wisdom', 'Teaching through personal adventure and exploration', 'Finding meaning in all experiences', 'Inspiring others to seek their own truth'],
      challenges: ['Getting lost in details without seeing the bigger picture', 'Difficulty committing to one path or philosophy', 'Scattered energy preventing depth', 'Talking about experiences without internalizing them'],
      advice: ['Develop one coherent philosophy from your many experiences', 'Travel with intention, not just movement', 'Teach what you have lived, not just what you have read', 'Your truth must be earned through direct experience'],
    },
    capricorn: {
      planet: 'northnode',
      sign: 'capricorn',
      keywords: ['karmic authority', 'soul mastery', 'responsibility path', 'structure dharma', 'achievement destiny'],
      general: 'North Node in Capricorn indicates your soul\'s path leads toward taking responsibility and developing mastery. Past-life tendencies toward emotional dependency and family enmeshment (South Node in Cancer) must be released. Your destiny involves developing self-discipline, taking on leadership, and building something that outlasts you.',
      strengths: ['Building enduring structures and institutions', 'Teaching the value of discipline and patience', 'Taking responsibility without resentment', 'Modeling mature emotional self-regulation'],
      challenges: ['Falling back into emotional dependency', 'Difficulty taking charge without guilt', 'Fear of leaving the family comfort zone', 'Resistance to structure and discipline'],
      advice: ['Take responsibility for your life direction without waiting for permission', 'Your ambition is not cold — it is purposeful', 'Build something that serves the collective, not just yourself', 'Emotional maturity includes the ability to function independently'],
    },
    aquarius: {
      planet: 'northnode',
      sign: 'aquarius',
      keywords: ['karmic community', 'soul innovation', 'humanity path', 'freedom dharma', 'collective destiny'],
      general: 'North Node in Aquarius indicates your soul\'s path leads toward serving the collective and embracing innovation. Past-life tendencies toward personal drama and creative self-focus (South Node in Leo) must be released. Your destiny involves contributing to something larger than yourself, embracing your uniqueness as a gift to humanity.',
      strengths: ['Ability to see beyond personal concerns to collective needs', 'Innovating solutions that benefit the many', 'Teaching that individuality serves the whole', 'Building communities based on shared ideals'],
      challenges: ['Getting caught in personal drama or ego needs', 'Difficulty collaborating when not in the spotlight', 'Resistance to unconventional approaches', 'Fear of being "different" or rejected'],
      advice: ['Your uniqueness is your contribution to the whole', 'Serve the collective without losing yourself', 'Innovation requires trusting your unconventional ideas', 'The best leaders create leaders, not followers'],
    },
    pisces: {
      planet: 'northnode',
      sign: 'pisces',
      keywords: ['karmic surrender', 'soul compassion', 'spiritual path', 'devotion dharma', 'unity destiny'],
      general: 'North Node in Pisces indicates your soul\'s path leads toward spiritual surrender and universal compassion. Past-life tendencies toward perfectionism and excessive self-criticism (South Node in Virgo) must be released. Your destiny involves learning to trust the flow of life, developing compassion for yourself and others, and experiencing the divine directly.',
      strengths: ['Teaching surrender as a path to strength', 'Deep compassion born from self-acceptance', 'Artistic and spiritual channeling', 'Helping others release perfectionism'],
      challenges: ['Getting stuck in critical self-analysis', 'Need for control and certainty', 'Difficulty trusting intuitive knowing', 'Mistrusting anything that cannot be measured'],
      advice: ['Practice letting go of one control each day', 'Your intuition is your most reliable guide', 'Compassion for yourself is the gateway to compassion for all', 'The divine does not require your perfection — only your presence'],
    },
  },
};
